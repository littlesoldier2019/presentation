    ...
    return (
        <div className="sidebar">
            ...
            <ul>
                ...
                {/* <li>< a href="/team"><i className="fas fa-user"></i>Team</a></li> */}
                <li><a href="/aboutproject"><i className="fas fa-tasks"></i>About Project</a></li>
                <li><a href="/tools&techs"><i className="fas fa-digital-tachograph"></i>Tools & Tech</a></li>
                <li><a href="/designs"><i className="fas fa-project-diagram"></i>Designs</a></li>
                <li><a href="/demo"><i className="fas fa-blog"></i>Demo</a></li>
